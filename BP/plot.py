...
ax_main_1.plot(x, lles.T[0],'--x' ,color='b',label=' $\delta_{1}$')
ax_main_1.plot(x, lles.T[1],'--x' ,color='g',label=' $\delta_{2}$')
ax_main_1.plot(x, lles.T[2],'--x' ,color='r',label=' $\delta_{3}$')
ax_main_1.plot(x, lles.T[3],'--x' ,color='c',label=' $\delta_{4}$')
ax_main_1.plot(x, lles.T[4],'--x' ,color='y',label=' $\delta_{5}$')
